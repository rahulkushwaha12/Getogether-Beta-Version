...
echo "
<center><iframe src='http://localhost/fb/like_but_frame.php?uid=$added_by$id' style=' border: 0px; height: 28px; width: 120px;'> </iframe></center>
...
$create_button = mysql_query("INSERT INTO like_buttons VALUES ('', '$username1', 'http://localhost/fb/$username1', '$date', '$username1')");
...
<iframe src='http://localhost/fb/like_but_frame.php?uid=<?php echo $username1 ;?> ' style='border: 0px; height: 28px; width: 120px;'> </iframe>
<style type="text/css">
h3{
	color:#669966;
